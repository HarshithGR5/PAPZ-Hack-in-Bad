...
contract_address = "0xeDC17cA1340CD68f5cc8F5fF97DAa80876CC7755"
contract_abi = [
	{
		"inputs": [
			{
...
admin_account = "0x56304c9bD4E4f0914B3d3243c64cf363eb1Fc53c"
...
def visualisation():
    ...
    try:
        ...
        try:
            ...
            current_app.logger.info(f"Affected parts: {affected_parts}")
...
@app.route('/admin_face', methods=['GET', 'POST'])
def admin_face():
    
    if request.method == 'GET':
        return render_template('admin_face.html')  # this page has the webcam
    ...
    c = conn.cursor()
    username = 'sam'
    c.execute("SELECT face_token FROM Admin_face WHERE username = %s", (username,))
